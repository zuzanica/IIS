<?php
// source: /opt/lampp/htdocs/my-first_nette/app/config/config.neon 
// source: /opt/lampp/htdocs/my-first_nette/app/config/config.local.neon 

class Container_41c9ec9025 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/opt/lampp/htdocs/my-first_nette/app',
			'wwwDir' => '/opt/lampp/htdocs/my-first_nette/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/opt/lampp/htdocs/my-first_nette/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/opt/lampp/htdocs/my-first_nette/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/opt/lampp/htdocs/my-first_nette/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/opt/lampp/htdocs/my-first_nette/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_41c9ec9025_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/opt/lampp/htdocs/my-first_nette/app/../temp/cache/latte');
...
final class Container_41c9ec9025_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_41c9ec9025 $container)
	{
