...
class Container_f965836f35 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\PostPresenter' => array(array('application.2')),
		...
		'services' => array(
			...
			'application.2' => 'App\Presenters\PostPresenter',
	...
	{
		return new Container_f965836f35_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_f965836f35_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_f965836f35 $container)
	{
