<?php
// source: /opt/lampp/htdocs/IIS/app/presenters/templates/Tables/alltables.latte

class Template9ec55a66aeac47dbeb11ee5f41228c4a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6240c11449', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbb71d040f8c_content')) { function _lbb71d040f8c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>	<h2>Stoly </h2>
