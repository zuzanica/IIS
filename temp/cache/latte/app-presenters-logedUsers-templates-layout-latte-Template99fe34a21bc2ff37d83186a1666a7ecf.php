<?php
// source: /opt/lampp/htdocs/IIS/app/presenters/logedUsers/templates/@layout.latte

class Template99fe34a21bc2ff37d83186a1666a7ecf extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8c334e2221', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb7f3b326caa_head')) { function _lb7f3b326caa_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb07d14480f0_title')) { function _lb07d14480f0_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>		 	<h2>Prihlásenie</h2>
<?php
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbe3dee466b2_scripts')) { function _lbe3dee466b2_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
">Denne menu</a></li>
		<li><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Menu:"), ENT_COMPAT) ?>
">Jenálniček</a></li>
...
<?php if ($user->isAllowed('Tables')) { ?>
	    	<li><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("logedUsers\Tables:"), ENT_COMPAT) ?>
">Stoly</a></li> 
<?php } ?>
