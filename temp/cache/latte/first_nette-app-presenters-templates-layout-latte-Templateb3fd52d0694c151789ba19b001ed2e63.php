<?php
// source: /opt/lampp/htdocs/my-first_nette/app/presenters/templates/@layout.latte

class Templateb3fd52d0694c151789ba19b001ed2e63 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1984f0e3f1', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb61c352e006_head')) { function _lb61c352e006_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb6825c54634_scripts')) { function _lb6825c54634_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
